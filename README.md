...
<p align="center">
  <a href="https://api.shunyin.eu.cc/sign-up?aff=P5tA">
    <img src="readme-image/Sponsor/sponsor-xiai.png" width="200" alt="XIAI中转">
  </a>
</p>
...
### 推荐方式：下载 Windows 安装包（普通用户）

前往 [Releases](https://github.com/lntomF/codexskin/releases) 页面，下载最新版本的 Windows 安装包：

- `CodeSkin_*_x64-setup.exe`：Windows 64 位安装包

下载后双击安装包，按照向导完成安装即可。

> 如果 Windows SmartScreen 提示“未知发布者”，通常是因为当前安装包尚未进行代码签名。
> 请确认安装包来自本项目的官方 Releases 页面。

安装完成后，可以从开始菜单或桌面快捷方式启动 CodeSkin。

### 开发者：从源码构建

如果你希望自己构建 CodeSkin，请先准备以下环境：
...
- [贡献指南](CONTRIBUTING.md)：开发、文档、测试与主题投稿说明
- [素材与授权说明](NOTICE.md)：代码和文档的开源范围，以及视觉素材的例外
- [素材政策](ASSET_POLICY.md)：仅接受原创或明确允许再分发的素材
- [安全政策](SECURITY.md)：安全问题请使用私密漏洞报告，不要公开提交 Issue
- [支持指南](SUPPORT.md)：区分求助、功能建议、兼容性反馈与安全问题
- [路线图](ROADMAP.md)：近期改进方向、社区目标与非目标
- [社区行为准则](CODE_OF_CONDUCT.md)：参与讨论和提交贡献时的基本规范
- [MIT 许可证中文说明](LICENSE.zh-CN.md)：中文参考说明；正式英文许可证见 [LICENSE](LICENSE)
- [英文文档](docs/en/README.md)：面向国际贡献者的项目介绍与协作说明
...
- 当前仅支持 Windows。
- CodeSkin 依赖 Codex Desktop 的本地 CDP 能力。
- Codex 更新后，页面结构或启动参数变化可能导致注入失败。
- 如果出现异常，请先点击“恢复官方外观”，再反馈问题。
- 提交 Issue 时请附上 Windows 版本、Codex 版本和错误信息。
...
Star 一下，挑一张自己喜欢的图，把 Codex 变成今天想要的样子。
